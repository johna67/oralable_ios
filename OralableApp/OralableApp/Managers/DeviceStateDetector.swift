...
enum DeviceState: String, CaseIterable {
    case onChargerIdle = "On Charger (Idle)"
    case offChargerIdle = "Off Charger (Idle)"
    case onMuscle = "On Muscle/Cheek"
    ...
    var description: String {
        switch self {
        case .onChargerIdle:
            return "Device is charging and not being worn"
        case .offChargerIdle:
            return "Device is idle and not being worn"
        case .onMuscle:
            return "Device is actively measuring on tissue"
        case .inMotion:
            return "Device is moving or being handled"
        case .unknown:
