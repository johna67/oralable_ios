...
//  Purpose: Display patient's HealthKit data correlated with bruxism metrics
//
        ...
        VStack(alignment: .leading, spacing: designSystem.spacing.md) {
            ...
            VStack(alignment: .leading, spacing: designSystem.spacing.sm) {
                InsightRow(
                    ...
                    text: "Heart rate variability may indicate stress levels correlating with bruxism episodes"
                )

                if let avgSpO2 = healthKit.averageSpO2, avgSpO2 < 95 {
                    InsightRow(
                        icon: "exclamationmark.triangle.fill",
                        text: "Lower oxygen saturation detected - may indicate sleep apnea, a known bruxism risk factor",
                        iconColor: .orange
                    )
                }
                ...
                InsightRow(
                    ...
                    text: "Correlation between sleep quality and grinding intensity can help tailor treatment"
                )
            }
        }
        .padding(designSystem.spacing.md)
